...
export const SERVICE_SKILL_OPTIONS = [
  'UI',
  'UX',
  'Html',
  'JavaScript',
...
export const SERVICE_STUDENT_PREREQUISITES = [
  { value: 'No pre-requisites', label: 'No pre-requisites' },
