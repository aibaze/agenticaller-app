...
export const _sentences = [
  'Initial interview to show how coaching works.',
  'First round of coaching sessions to set goals and objectives.',
  'Midway through the coaching program to improve outputs and make adjustments.',
